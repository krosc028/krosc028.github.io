...
function update(){
    ...
    if (easy.checked){
        for(let i = 0; i < 10; i++) {
            ...
            while(x==="true"){
                var n = Math.floor(Math.random()*n_list.length);
                let compar= charLeft-n_list[n].length;
                if (minWordLength <=n_list[n].length<= maxWordLenth){
                    noun= n_list[n];
            ...
            while(x==="true"){
                ...
                if (minWordLength <=v_list[v].length<= maxWordLenth && compar>= minWordLength){
                    verb= v_list[v];
            ...
            while(x==="true"){
                ...
                if (minWordLength <=a_list[a].length<= maxWordLenth && compar>= 0){
                    adj= a_list[a];
...
var string_verbs= "crawl\tknit\tturn\n"+"arise\n" + "awake\n" + "be\n" + "bear\n" + "beat\n" + "become\n" + "begin\n" + "bend\n" + "bet\n" + "bind\n" + "bite\n" +
    ...
    "lie\twalk"+ "ask\topen\n" + "calculate\tpaint\n" + "close\tplay\n" + "count\tread\n" + "cut\tsay\n" + "draw\tshow\n" + "experiment\tsing\n" + "explain\tspell\n" +
    "give\tstudy\n" + "listen\tteach\n" + "observe\tthink" +"was\n were\n is\n are \n go \n get \n got";
/*theNumber var i = Math.floor(Math.random()*100)
check = function() {
